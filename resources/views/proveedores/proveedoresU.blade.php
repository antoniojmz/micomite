      ...
      @foreach ($v_proveedores as $prov)
          <div class="portfolio {{ $prov->id_categoria }}" data-cat="{{ $prov->id_categoria }}" >
           ...
           <div class="votacion">
              ...
              <br>
                   <div class="col-md-12">
                        <button type="button" class="btn btn-primary" data-toggle="modal"  data-target="{{ '#myModal'.$prov->id_proveedor }}">Detalles </button>
                        <button id="evaluar" value="{{$prov->id_proveedor}}" data-toggle="modal"  data-target="{{ '#myModal2'.$prov->id_proveedor }}" type="button" class="btn btn-success parametro">Evaluar</button>
                        <button id="evaluaciones" value="{{$prov->id_proveedor}}" type="button" class="btn btn-info evaluaciones">Comentarios</button>
                  </div>
              </div>
            </div>
...
<script src="{{ asset('js/menu/menu_msj.js') }}"></script>
<script src="{{ asset('js/simple-portfolio-page/js/jquery.mixitup.min.js') }}">
</script>
