...
<html lang="en">
	...
	<body>
		...
		<div   class="easyui-layout" style="width:100%;height:700px;">
			        ...
			        <header style="background-image: linear-gradient(to bottom, rgb(47, 145, 230) 0px, rgb(23, 129, 221) 100%);border-bottom: 5px solid #EEE;height:60px;padding-top:1px;">
<table width="100%" border="0"><tr><td width="85%">
