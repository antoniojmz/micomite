...
$(function () {
    var filterList = {
  	...
  	load: {
          filter: '.principal' // show app tab on first load
        }
        });
      }
    };
...
var mostrarVotacion = function(){
  //  $('.divForm').toggle();
    ...
    $('.id_proveedor').val(valor_id);
};


var volverVotacion = function(){
//    $('.divForm').toggle();
};
...
var asignarProveedorId= function(){
   var com = $(this).val();
   $('.id_proveedor').val(com);
};


var mostrarVotacion = function(){
    var valor_id = $(this).attr("value");
     parametroAjax.data = {'id_proveedor': valor_id };
...
var abrirModalComentarios = function(respuesta){
    ...
    $("#tituloProveedor").text(objeto[0].proveedor);
...
var cargarTablaComentarios = function(data){
...
$(document).ready(function(){
    ...
    $(document).on('click','.parametro',asignarProveedorId);
    $(document).on('click','#cancelar',volverVotacion);
    $(document).on('change','#comentariost',capturaComentario);
    $(document).on('click','.filter',ocultarBanner);
